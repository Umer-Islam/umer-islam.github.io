...
import Me from "../asset/download.jpg";
      ...
      <div className="items-center space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
        <div className="flex flex-col items-center pt-8">
          ...
          <p className="text-gray-500 dark:text-gray-300 text-center">
            Hey my name is Umer and I am a Full Stack Developer
          </p>

          <div className="flex space-x-5 pt-6">
            <a href="https://github.com/umer-islam" target="_blank">{/* github */}
              <svg
            ...
            <a href="" target="_blank">{/* X / Twitter */}
              <svg
                viewBox="0 0 1024 1024"
                fill="currentColor"
                className="w-8 h-8 text-teal-500 hover:text-teal-600"
        ...
        <div className="prose max-w-none prose-lg pt-8 pb-7 dark:prose-invert xl:col-span-2">
          <p>
            Hey everyone my name is umer, i am a Full Stack
            developer.
          </p>
          <p>
            I love building Full Stack applications with React and Nextjs. When I discovered React, I was blown away by its
